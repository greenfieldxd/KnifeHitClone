...
#elif UNITY_IOS 
        if(SystemInfo.deviceModel.ToLower().Contains("iPhone10".ToLower()) ||
            SystemInfo.deviceModel.ToLower().Contains("iPhone11".ToLower()) ||
            SystemInfo.deviceModel.ToLower().Contains("iPhone12".ToLower()) ||
            SystemInfo.deviceModel.ToLower().Contains("iPhone8".ToLower()) ||
            SystemInfo.deviceModel.ToLower().Contains("iPhone7".ToLower()))
            VibratePop();
        else
        {
            Handheld.Vibrate();
